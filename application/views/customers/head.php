            ...
            <div class="container">
                <div class="row d-flex justify-content-between align-items-center">
                    ...
                    <div class="dlab-topbar-right">
                        <a href="contact-1.html" class="site-button btnhover21 radius-no">GET A QUOTE</a>						
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container clearfix">
                    <!-- website logo -->
                     <div class="logo-header mostion logo-white">
                        <a href="index.html"><img src="<?= base_url() ?>assets/asset_fr/images/logo_gandeng.png" alt=""></a>
                    </div>
                    <!-- nav toggle button -->
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        <div class="logo-header d-md-block d-lg-none">
                            <a href="index.html"><img src="<?= base_url() ?>assets/asset_fr/images/logo-8.png" alt=""></a>
                        </div>
