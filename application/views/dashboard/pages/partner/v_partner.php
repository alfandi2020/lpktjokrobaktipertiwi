            ...
            <div class="card">
                <div class="card-header card-no-border">
                    <div class="card-header-right">
                        <a href="<?= base_url('dash/partner/create') ?>" type="button" class="btn btn-primary">Create new</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('dash/partner/edit/' . $p->slug) ?>" class="btn btn-primary btn-sm">Edit</a>
