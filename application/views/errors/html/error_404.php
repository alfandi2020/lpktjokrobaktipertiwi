...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="icon" href="<?= base_url() ?>assets/asset_fr/images/favicon.ico" type="image/x-icon" />
	<link rel="shortcut icon" type="image/x-icon" href="<?= base_url() ?>assets/asset_fr/images/favicon.png" />
			...
			<div class="container">
				<div class="row max-w700 dlab-bnr-inr-entry dz_error-404-area align-m dz_error-404 text-white m-auto">
					...
					<div class="col-lg-8 col-md-8 m-b30 text-left">
						...
						<a href="<?= base_url() ?>" class="site-button">Go To Home</a>
					</div>
				</div>
			</div>
		</div>
