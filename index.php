...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>YAYASAN TJOKRO PERSADA BAKTI PERTIWI</title>
...
<div id="loading-area"></div>
			...
			<div class="container">
				<div class="row d-flex justify-content-between">
					...
					<div class="dlab-topbar-right topbar-social">
						<ul>
							<li><a href="https://wa.me/628176877606" target="_blank" class="site-button-link twitter hover"><i class="fa fa-whatsapp"></i></a></li>
							<li><a href="https://wa.me/6285714243325" target="_blank" class="site-button-link twitter hover"><i class="fa fa-whatsapp"></i></a></li>
							<li><a href="https://wa.me/6281227640349" target="_blank" class="site-button-link twitter hover"><i class="fa fa-whatsapp"></i></a></li>
							<li><a href="https://wa.me/628119401954" target="_blank" class="site-button-link twitter hover"><i class="fa fa-whatsapp"></i></a></li>
							<li><a href="https://www.facebook.com/profile.php?id=61551065793688" class="site-button-link facebook hover"><i class="fab fa-facebook-f"></i></a></li>
							<!-- <li><a href="#" class="site-button-link google-plus hover"><i class="fab fa-google-plus-g"></i></a></li> -->
							<li><a href="https://www.instagram.com/lpktjokrobaktipertiwi/" class="site-button-link instagram hover"><i class="fab fa-instagram"></i></a></li>
							<!-- <li><a href="#" class="site-button-link linkedin hover"><i class="fab fa-linkedin-in"></i></a></li> -->
							<li><a href="https://www.youtube.com/@ytpbaktipertiwi9643" class="site-button-link youtube hover"><i class="fab fa-youtube"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
        ...
        <div class="sticky-header main-bar-wraper navbar-expand-lg">
            <div class="main-bar clearfix ">
                <div class="container clearfix">
                    ...
                    <!-- extra nav -->
                    <div class="extra-nav">
						<a href="contact-1.html" class="site-button radius-no">Registrasi</a>
                    </div>
                    <!-- Quik search -->
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        ...
                        <ul class="nav navbar-nav">	
							...
							<li class="has-mega-menu"> <a href="javascript:;">Kesiswaan<i class="fas fa-chevron-down"></i></a>
								<ul class="mega-menu">
									<li><a href="javascript:;">Element</a>
										<ul>
											<li><a href="shortcode-buttons.html"><i class="ti-mouse"></i> Buttons</a></li>
    ...
    <div class="page-content bg-white">
        ...
        <div class="content-block">
			...
			<div class="section-full bg-white content-inner-1 project-area  bg-img-fix" style="background-image:url(images/background/bg9.jpg); background-size: cover;">
                <div class="container">
